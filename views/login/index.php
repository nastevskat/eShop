...
<head>
    ...
    <title>Најави се| Купи Книга</title>
				...
				<div class="col-sm-4 col-sm-offset-1" style="float: none; display: inline-block;">
					<div class="login-form"><!--login form-->
						...
						<form method="post" action="">
							...
							<button type="submit" name="action" class="btn btn-default" value="Login">Најави ме</button>
						</form>
						<br> <a href='/login/signup' >Немате профил? Регистрирајте се тука. </a>
					</div><!--/login form-->
				</div>
